...
const VideoIntroduction = () => {
  return (
    <section className="py-20 px-4 bg-gradient-to-b from-background via-secondary/10 to-background relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="container mx-auto max-w-5xl relative z-10">
        <div className="text-center mb-12 animate-fade-up">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
            Watch how Kumii empowers entrepreneurs and SMMEs across South Africa with 
            access to capital, mentorship, and market opportunities
          </p>
        </div>
