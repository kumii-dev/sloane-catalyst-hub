        ...
        {listings.length > 0 && (
          <section className="bg-muted/30 rounded-lg p-8 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div>
                <div className="text-3xl font-bold text-primary mb-2">{listings.length}+</div>
                <div className="text-muted-foreground">Services Available</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-primary mb-2">
                  {new Set(listings.map(l => l.listing_type)).size}+
                </div>
                <div className="text-muted-foreground">Service Types</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-primary mb-2">
                  {listings.reduce((acc, l) => acc + l.total_subscriptions, 0)}+
                </div>
